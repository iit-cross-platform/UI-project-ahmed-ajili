...
import ListePlaylist from "./screen/ListePlaylist";
    ...
    <ApplicationProvider {...eva} theme={eva.light}  >
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen name="Menu" component={PlaylistScreen}></Stack.Screen>
          <Stack.Screen name="Artiste" component={ArtisteScreen}></Stack.Screen>
          <Stack.Screen name="ListePlaylist" component={ListePlaylist}></Stack.Screen>
        </Stack.Navigator>
      </NavigationContainer>
    </ApplicationProvider>
  );
